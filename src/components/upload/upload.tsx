        ...
        >
          ...
          {file.status === 'uploading'
                    ...
                    <div className="progress">
                      ...
                      <div className="percent" style={{ width: `${file.percent}%` }} />
                    </div>
          )}
        </div>
      ));
      ...
      return (
        <div className="list-text">
          {Object.values(this.files).map((file) => (
            <div className="item" key={file.uid}>
              <div className="text">
                {file.status !== 'pre-treated' && (
                <div className="icon left"><Icon type="attachment" /></div>
                )}
                {file.status === 'pre-treated' && (
                <div className="icon left"><Icon type="loading" /></div>
                )}
                <div
                  className="icon right delete"
                  onClick={() => this.onDelete(file)}
                >
                  <Icon type="close" />
                </div>
                {file.status === 'error' && (
                <div
                  className="icon right re-upload"
